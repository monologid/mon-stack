...
export const Modal: FC<ModalProps> = ({
  ...
  const modalClasses = isOpen ? 'fixed z-20 inset-0 overflow-y-auto' : 'hidden';
    ...
    <>
      ...
      <div className={modalClasses}>
        {!isLoading ? (
          ...
          >
            ...
            >
              <Heading
                variant={'h4'}
                className={
                  'uppercase font-bold text-slate-500 border-b border-slate-200 p-4 tracking-wider text-sm'
                }
              >
                {title}
              </Heading>
          ...
          <div
            className={
              'w-[400px] mx-auto rounded bg-white flex flex-col justify-center items-center mt-20 py-10 space-y-4'
            }
          >
